                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-2 mb-md-0">
                                    <label for="net-cost" class="form-label d-block mb-1">
                                        <?php esc_html_e('Buy Price', 'obydullah-restaurant-pos-lite'); ?><span class="currency-symbol mr-2"> (<?php echo esc_html($this->get_currency_symbol()); ?>)</span><span class="text-danger">*</span>
                                    </label>
